...
void MPC::init(int steps, double dt, double max_vel, double max_acc,
               double max_delta, double max_delta_rate, double L, double kcte,
               double kepsi, double kv, double ksteer_cost) {
  this->t_end = steps * dt;
  this->steps = steps;
...
void MPC::solve(double v0, double delta0, std::vector<double> &traj_coef,
                double &rate_u, double &acc_u, std::vector<double> &res_x,
