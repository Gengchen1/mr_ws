...
MPC::MPC(int steps, double dt, double max_vel, double max_acc, double max_delta,
...
void MPC::solve(double current_linear_velocity, double cmd_steer_angle, std::vector<double>& control_coefs,
               double& rate_u, double& acc_u, std::vector<double>& mpc_x,
